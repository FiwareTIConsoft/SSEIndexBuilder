...
export DBPEDIA_WORKSPACE=../data/sse/dbpedia/it

export INDEX_CONFIG_FILE=../conf/indexing.sse.it.properties
...
# add sameAs to index (only for the Italian Index)
#echo -e "Adding SameAs to index... \n"
