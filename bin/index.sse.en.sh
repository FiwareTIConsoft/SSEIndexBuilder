...
export DBPEDIA_WORKSPACE=../data/sse/dbpedia/en

export INDEX_CONFIG_FILE=../conf/indexing.sse.en.properties
...
#mvn compile
#mvn exec:java -e -Dexec.mainClass="org.dbpedia.spotlight.lucene.index.external.utils.SSERedirectCleaner" -Dexec.args=$INDEX_CONFIG_FILE

#clean the Wikipedia Dump (added by Giuseppe Futia)
#mvn compile
#mvn exec:java -e -Dexec.mainClass="org.dbpedia.spotlight.lucene.index.external.utils.SSEWikiDumpCleaner" -Dexec.args=$INDEX_CONFIG_FILE
...
#mvn compile
#mvn exec:java -e -Dexec.mainClass="org.dbpedia.spotlight.lucene.index.external.utils.SSEUriDecoder" -Dexec.args=$INDEX_CONFIG_FILE
...
# create the Knowledge Base Index of SSE (added by Giuseppe Futia)
#echo -e "Create the Knowledge Base Index of SSE... \n"
mvn compile
mvn exec:java -e -Dexec.mainClass="org.dbpedia.spotlight.lucene.index.external.SSEKnowledgeBaseBuilder" -Dexec.args=$INDEX_CONFIG_FILE

# create the Residual Knowledge Base Index of SSE (added by Giuseppe Futia)
echo -e "Create the Residual Knowledge Base Index of SSE... \n"
mvn compile
mvn exec:java -e -Dexec.mainClass="org.dbpedia.spotlight.lucene.index.external.SSEResidualKnowledgeBaseBuilder" -Dexec.args=$INDEX_CONFIG_FILE
