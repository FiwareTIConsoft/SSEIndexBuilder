...
export DBPEDIA_WORKSPACE=/data/dbpedia-spotlight/dbpedia2014/it
export INDEX_CONFIG_FILE=/data/dbpedia-spotlight/conf/indexing.tmf.it.properties
export JAVA_XMX=16g
...
java -Xmx$JAVA_XMX -cp index-06.jar org.dbpedia.spotlight.lucene.index.external.AddSameAsToIndex $INDEX_CONFIG_FILE $DBPEDIA_WORKSPACE/output/index-withTypesTitlesImages > out_AddSameAsToIndex.log 2>&1
