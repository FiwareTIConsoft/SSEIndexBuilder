...
public class SpotlightConfiguration {
    ...
    //@Deprecated
    //Italian DEFAULT_NAMESPACE - Uncomment the line below for building SSE Italian Indexes
    //public static String DEFAULT_NAMESPACE = "http://it.dbpedia.org/resource/";

    //English DEFAULT_NAMESPACE - Uncomment the line below for building SSE English Indexes
